...
import { ChevronDown, ChevronRight, Clock, MapPin, GripVertical, Edit } from "lucide-react";
...
export const TaskManageCard = ({ task, onEdit }: TaskManageCardProps) => {
  ...
  return (
    <div className="app-card p-4 interactive-hover shadow-sm border">
